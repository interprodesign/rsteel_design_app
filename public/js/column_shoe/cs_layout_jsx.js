    ...
    */
    ...
    var initRebarDraw = function () {
        ...
        if (section_type == "rect") {
            ...
            for (var i = 1; i <= 2; i++) {
                rebar_data.push({
                    'cover': parseFloat(jQuery("#cs_cover_" + i).val()),
                    'side_1': parseFloat(jQuery("#cs_rebar_side_1_" + i).val()),
                    'side_2': parseFloat(jQuery("#cs_rebar_side_2_" + i).val()),
                    'side_3': parseFloat(jQuery("#cs_rebar_side_3_" + i).val()),
                    'side_4': parseFloat(jQuery("#cs_rebar_side_4_" + i).val()),
                    'side_diam_1': parseFloat(jQuery("#cs_side_diam_1_" + i).val()),
                    'side_diam_2': parseFloat(jQuery("#cs_side_diam_2_" + i).val()),
                    'side_diam_3': parseFloat(jQuery("#cs_side_diam_3_" + i).val()),
                    'side_diam_4': parseFloat(jQuery("#cs_side_diam_4_" + i).val()),
                    'corner_1': document.getElementById("cs_rebar_corner_1_" + i).checked,
                    'corner_2': document.getElementById("cs_rebar_corner_2_" + i).checked,
                    'corner_3': document.getElementById("cs_rebar_corner_3_" + i).checked,
                    'corner_4': document.getElementById("cs_rebar_corner_4_" + i).checked,
                    'corner_diam_1': parseFloat(jQuery("#cs_corner_diam_1_" + i).val()),
                    'corner_diam_2': parseFloat(jQuery("#cs_corner_diam_2_" + i).val()),
                    'corner_diam_3': parseFloat(jQuery("#cs_corner_diam_3_" + i).val()),
                    'corner_diam_4': parseFloat(jQuery("#cs_corner_diam_4_" + i).val())
                });
            };
            ...
            for (var i = 0; i < rebar_data.length; i++) {
                ...
                if (layer.cover) {
                    ...
                    if (layer.side_1 != 0) for (bar in temp) rebar_coord.push([layer.side_diam_1, temp[bar]]);
                    // Corner bars
                    if (layer.corner_1) rebar_coord.push([layer.corner_diam_1, start_p]);
                };
                // Right Side
                if (layer.cover) {
                    var start_p = [0.5 * col_width - layer.cover, 0.5 * col_height - layer.cover];
                    ...
                    if (layer.side_2 != 0) for (bar in temp) rebar_coord.push([layer.side_diam_2, temp[bar]]);
                    // Corner bars
                    if (layer.corner_2) rebar_coord.push([layer.corner_diam_2, start_p]);
                };
                // Bottom Side
                if (layer.cover) {
                    var start_p = [0.5 * col_width - layer.cover, -0.5 * col_height + layer.cover];
                    ...
                    if (layer.side_3 != 0) for (bar in temp) rebar_coord.push([layer.side_diam_3, temp[bar]]);
                    // Corner bars
                    if (layer.corner_3) rebar_coord.push([layer.corner_diam_3, start_p]);
                };
                // Left Side
                if (layer.cover) {
                    var start_p = [-0.5 * col_width + layer.cover, -0.5 * col_height + layer.cover];
                    ...
                    if (layer.side_4 != 0) for (bar in temp) rebar_coord.push([layer.side_diam_4, temp[bar]]);
                    // Corner bars
                    if (layer.corner_4) rebar_coord.push([layer.corner_diam_4, start_p]);
                };
            };
