CS_LAYOUT = (function () {
    ...
    var initSecDefaultData = function (sec_type) {
        if (sec_type == "rect") {
            ...
            jQuery("#cs_cover_1").val('50');
            jQuery("#cs_rebar_side_1_1").val('1');
            jQuery("#cs_rebar_side_2_1").val('1');
            jQuery("#cs_rebar_side_3_1").val('1');
            jQuery("#cs_rebar_side_4_1").val('1');
            jQuery("#cs_side_diam_1_1").val('16');
            jQuery("#cs_side_diam_2_1").val('16');
            jQuery("#cs_side_diam_3_1").val('16');
            jQuery("#cs_side_diam_4_1").val('16');
            jQuery("#cs_corner_diam_1_1").val('16');
            jQuery("#cs_corner_diam_2_1").val('16');
            jQuery("#cs_corner_diam_3_1").val('16');
            jQuery("#cs_corner_diam_4_1").val('16');
        }
    ...
    var initSectioninputs = function (sec_type) {
        ...
        function initChangeEvents(sec_type) {
            ...
            if (sec_type == 'rect') {
                ...
                for (var j = 1; j <= 2; j++) {
                    for (var i in ids_rect_arr_2) {
                        jQuery(ids_rect_arr_2[i] + j).unbind().on('change', function () { CS_LAYOUT_JSX.initRebarDraw() });
                    };
                };
            }
            else if (sec_type == 'round') {
        ...
        if (sec_type == "rect") {
            jQuery("#cs_sec_image img").attr("src", "img/column_shoe/cs_select_rect.png");
            ...
            jQuery("#cs_col_shoes_inputs").append('\
                    ...
                    <img src="cs_rect_shoes_pos.png" style="width:50%">\
                    </div>\
                    </div>\
            ...
            jQuery("#cs_shoe_image").append('<img src="img/column_shoe/cs_rect_shoes_pos.png" style="width:135px;padding-left:20px;">');
            ...
            jQuery("#cs_sec_rebar_inputs").append('\
                        ...
                        <div class="w3-third tablink w3-bottombar w3-hover-light-grey w3-padding w3-border-indigo w3-center">Layer 1</div>\
                        </a>\
            ...
            for (i = 1; i <= 2; i++) {
                jQuery("#cs_sec_rebar_inputs").append('\
                        ...
                        <div class="w3-bar-block">\
                        <img src="img/column_shoe/cs_rect_reb_layer_'+ i + '_1.png" style="width:75%">\
                        </div>\
                        </div>\
                        <!-- Column 2 -->\
                        ...
                        <!-- Column 3 -->\
                        <div class="w3-col w3-margin-left" style="width:20%">\
                        <label><i class="fa fa-flickr"></i> Rebar Diam.</label>\
                        <select id="cs_side_diam_1_'+ i + '" type="diams" class="w3-select w3-border" name="option"></select>\
                        <label><i class="fa fa-flickr" style="margin-top: 18px"></i> Rebar Diam.</label>\
                        <select id="cs_side_diam_2_'+ i + '" type="diams" class="w3-select w3-border" name="option"> </select>\
                        <label><i class="fa fa-flickr" style="margin-top: 17px"></i> Rebar Diam.</label>\
                        ...
                        <div class="w3-col w3-center" style="width:20%">\
                        <div class="w3-bar-block">\
                        <img src="img/column_shoe/cs_rect_reb_layer_'+ i + '_2.png" style="width:60%">\
                        </div>\
                        </div>\
                        <!-- Column 2 -->\
                        <div class="w3-col w3-margin-left" style="width:20%">\
                        ...
                        <!-- Column 3 -->\
                        <div class="w3-col w3-margin-left" style="width:20%">\
                        <label><i class="fa fa-delicious"></i> Rebar Diam.</label>\
                        <select id="cs_corner_diam_1_'+ i + '" type="diams" class="w3-select w3-border" name="option"></select>\
                        <label><i class="fa fa-delicious" style="margin-top: 18px"></i> Rebar Diam.</label>\
                        <select id="cs_corner_diam_2_'+ i + '" type="diams" class="w3-select w3-border" name="option"> </select>\
                        <label><i class="fa fa-delicious" style="margin-top: 17px"></i> Rebar Diam.</label>\
            ...
            jQuery("#cs_sec_image img").attr("src", "img/column_shoe/cs_select_round.png");
            jQuery("#cs_section_dims").empty();
            jQuery("#cs_section_dims").append('\
            ...
            // Shoe parameters --------------------------------------------------------------------------------------------------------------
            jQuery("#cs_shoe_image").empty();
            jQuery("#cs_shoe_image").append('<img src="img/column_shoe/cs_round_shoes_pos.png" style="width:65%;padding-left:15px;">');
            jQuery("#cs_rect_shoes_data_1").empty();
            jQuery("#cs_rect_shoes_data_1").append('\
            ...
            jQuery("#cs_sec_rebar_inputs").append('\
                    ...
                    <div class="w3-col w3-center" style="width:20%;">\
                    <div class="w3-bar-block">\
                    <img src="img/column_shoe/cs_round_rebar.png" style="width:65%">\
                    </div>\
                    </div>\
                    <div class="w3-col w3-margin-left" style="width:20%">\
                    <div class="w3-bar-block">\
